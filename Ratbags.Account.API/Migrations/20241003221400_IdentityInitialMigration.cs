    ...
    public partial class IdentityInitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Authors__70DAFC34146F6217", x => x.AuthorId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Tags__657CF9ACA25CB477", x => x.TagId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Comments__Articl__4222D4EF",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ArticleA__CB6FDF2BF3789DAE", x => new { x.ArticleId, x.AuthorId });
                    table.ForeignKey(
                        name: "FK__ArticleAu__Artic__3E52440B",
                        column: x => x.ArticleId,
                        principalTable: "Articles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK__ArticleAu__Autho__3F466844",
                        column: x => x.AuthorId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ArticleT__4A35BF72117B76E6", x => new { x.ArticleId, x.TagId });
                    table.ForeignKey(
                        name: "FK__ArticleTa__Artic__47DBAE45",
                        column: x => x.ArticleId,
                        principalTable: "Articles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK__ArticleTa__TagId__48CFD27E",
                        column: x => x.TagId,
                        principalTable: "Tags",
